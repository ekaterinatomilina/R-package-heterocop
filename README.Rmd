---
title: "heterocop: an R package for Gaussian copula semi-parametric inference for mixed data"
...
kableExtra::kable_styling(font_size = 4, full_width = FALSE)
```
